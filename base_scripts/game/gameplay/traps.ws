...
exec function addTraps( )
{
AddAbility('mw');
thePlayer.GetInventory().AddItem('Explosive Trap', 10);
thePlayer.GetInventory().AddItem('Crippling Trap', 10);
thePlayer.GetInventory().AddItem('Freezing Trap', 10);
thePlayer.GetInventory().AddItem('Rage Trap', 10);
thePlayer.GetInventory().AddItem('Grappling Trap', 10);
thePlayer.GetInventory().AddItem('Trap Linker', 10);
thePlayer.GetInventory().AddItem('Harpy Bait Trap', 10);
thePlayer.GetInventory().AddItem('Nekker Stun Trap', 10);
thePlayer.GetInventory().AddItem('Tentadrake Trap', 10);
thePlayer.GetInventory().AddItem('Draug Trap', 10);
thePlayer.GetInventory().AddItem('Dragon Trap', 10);
thePlayer.GetInventory().AddItem('Animal Trap', 10);
thePlayer.GetInventory().AddItem('Used Trap', 10);
}
...
exec function addOldSwords( )
{
AddAbility('mw');
thePlayer.GetInventory().AddItem('Gwalhir');
thePlayer.GetInventory().AddItem('Dyaebl');
thePlayer.GetInventory().AddItem('Ardaenye');
thePlayer.GetInventory().AddItem('Moonblade');
}

exec function addSabres( )
{
AddAbility('mw');
thePlayer.GetInventory().AddItem('Elven Sword of Blue Mountains');//63
thePlayer.GetInventory().AddItem('Angivare');//70
thePlayer.GetInventory().AddItem('Dol Blathanna Quality Steel Blade');//64
thePlayer.GetInventory().AddItem('Dol Blathanna High Quality Steel Blade');//65
thePlayer.GetInventory().AddItem('Zerrikan Steel Sabre');//67
thePlayer.GetInventory().AddItem('Zerrikan Poisoned Steel Sabre');//68
thePlayer.GetInventory().AddItem('Dun Banner Sword');//62
thePlayer.GetInventory().AddItem('Elven Short Sihil');//66
thePlayer.GetInventory().AddItem('Elven Sword');//61
thePlayer.GetInventory().AddItem('Ceremonial Steel Sword of Deithwen');//69
}
...
{
AddAbility('mw');
thePlayer.GetInventory().AddItem('W_StennisSwd');
thePlayer.GetInventory().AddItem('W_Axe01');
thePlayer.GetInventory().AddItem('W_Axe02');
thePlayer.GetInventory().AddItem('W_Club01');
thePlayer.GetInventory().AddItem('W_Club02');
thePlayer.GetInventory().AddItem('W_Club03');
thePlayer.GetInventory().AddItem('W_AxeDwarf01');
thePlayer.GetInventory().AddItem('W_HammerDwarf01');
thePlayer.GetInventory().AddItem('W_ElvenMesser01');
thePlayer.GetInventory().AddItem('W_ElvenSword01');
thePlayer.GetInventory().AddItem('W_ElvenSword02');
thePlayer.GetInventory().AddItem('W_ExecRod');
thePlayer.GetInventory().AddItem('W_ExecSword');
thePlayer.GetInventory().AddItem('W_Halberd01');
thePlayer.GetInventory().AddItem('W_Halberd02');
thePlayer.GetInventory().AddItem('W_Hammer01');
thePlayer.GetInventory().AddItem('W_HenseltSword01');
thePlayer.GetInventory().AddItem('W_Messer01');
thePlayer.GetInventory().AddItem('W_Messer02');
thePlayer.GetInventory().AddItem('W_NilfgaardSword01');
thePlayer.GetInventory().AddItem('W_RustyDagger01');
thePlayer.GetInventory().AddItem('W_Sabre01');
thePlayer.GetInventory().AddItem('W_Sabre02');
thePlayer.GetInventory().AddItem('W_Staff01');
thePlayer.GetInventory().AddItem('W_Staff02');
thePlayer.GetInventory().AddItem('W_Staff03');
thePlayer.GetInventory().AddItem('W_Sword01');
thePlayer.GetInventory().AddItem('W_Sword02');
thePlayer.GetInventory().AddItem('W_Sword03');
thePlayer.GetInventory().AddItem('W_TwoHander01');
thePlayer.GetInventory().AddItem('W_WraithSword01');
thePlayer.GetInventory().AddItem('W_Paddle01');
thePlayer.GetInventory().AddItem('W_Rake01');
thePlayer.GetInventory().AddItem('W_SuccubusStaff01');
thePlayer.GetInventory().AddItem('W_PickAxe01');
thePlayer.GetInventory().AddItem('W_PickAxe02');
thePlayer.GetInventory().AddItem('W_DeathmoldStaff');
thePlayer.GetInventory().AddItem('W_Ladle01');
thePlayer.GetInventory().AddItem('W_Shovel01');
thePlayer.GetInventory().AddItem('W_Broom01');
thePlayer.GetInventory().AddItem('W_Pale01');
thePlayer.GetInventory().AddItem('Fishing Rod');
}

exec function addArmors( )
{
AddAbility('mw');
...
thePlayer.GetInventory().AddItem('Vran Armor');
thePlayer.GetInventory().AddItem('Roche Commando Jacket');
}
...
thePlayer.GetInventory().AddItem('Unique Leather Pants of Elder Blood');
thePlayer.GetInventory().AddItem('Unique Essenced Pants');
}
