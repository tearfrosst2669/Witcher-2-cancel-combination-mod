/*
**********************************************************************/
/** Witcher Script file (pMarK edited)
/***********************************************************************/
...
import class CPlayer extends CActor
{
    ...
    if ( isDodgeTimerOn == false )
    {
       ...
       // theGame.EnableButtonInteractions( false );
        AddTimer( 'DodgingTimer', 0.2f );
    }
    
    isDodge = true;
    lastDodgeTime = theGame.GetEngineTime();
    immortalityModeScene = AIM_Invulnerable;
    SetCanPlayHit( false );   // <-- suppress stagger/hit reaction during dodge
	SetAnimationTimeMultiplier( 1.5 );  // <-- speed up dodge animation
	}
	
	final function CancelDodge()
	{
    isDodge = false;
	...
	timer function DodgingTimer( timeDelta : float )
	{
		...
		isDodgeTimerOn = false;
		immortalityModeScene = AIM_None;
		 SetAnimationTimeMultiplier( 1.0 );  // <-- speed up dodge animation
	}
	...
	final function IsDodgeing() : bool
{
    ...
    {
        isDodge = false;
        immortalityModeScene = AIM_None;        // <-- clear when dodge ends
        return false;
    }
    else 
    {
        immortalityModeScene = AIM_Invulnerable; // <-- set while dodging
        return true;
    }
}
...
//		GetCharacterStats().AddAbility('alchemy_s1');
//		GetCharacterStats().AddAbility('alchemy_s1_2');
//		GetCharacterStats().AddAbility('alchemy_s2');
//		GetCharacterStats().AddAbility('alchemy_s2_2');
//		GetCharacterStats().AddAbility('alchemy_s3');
//		GetCharacterStats().AddAbility('alchemy_s3_2');
//		GetCharacterStats().AddAbility('alchemy_s4');
//		GetCharacterStats().AddAbility('alchemy_s4_2');
//		GetCharacterStats().AddAbility('alchemy_s5');
//		GetCharacterStats().AddAbility('alchemy_s5_2');
//		GetCharacterStats().AddAbility('alchemy_s6');
//		GetCharacterStats().AddAbility('alchemy_s6_2');
//		GetCharacterStats().AddAbility('alchemy_s7');
//		GetCharacterStats().AddAbility('alchemy_s7_2');
//		GetCharacterStats().AddAbility('alchemy_s8');
//		GetCharacterStats().AddAbility('alchemy_s8_2');
//		GetCharacterStats().AddAbility('alchemy_s9');
//		GetCharacterStats().AddAbility('alchemy_s9_2');
//		GetCharacterStats().AddAbility('alchemy_s10');
//		GetCharacterStats().AddAbility('alchemy_s10_2');
//		GetCharacterStats().AddAbility('alchemy_s11');
//		GetCharacterStats().AddAbility('alchemy_s11_2');
//		GetCharacterStats().AddAbility('alchemy_s12');
//		GetCharacterStats().AddAbility('alchemy_s12_2');
//		GetCharacterStats().AddAbility('alchemy_s13');
//		GetCharacterStats().AddAbility('alchemy_s13_2');
//		GetCharacterStats().AddAbility('alchemy_s14');
//		GetCharacterStats().AddAbility('alchemy_s14_2');
//		GetCharacterStats().AddAbility('alchemy_s15');
//		GetCharacterStats().AddAbility('alchemy_s15_2');
	}
